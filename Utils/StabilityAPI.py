...
class StabilityAPI:
    ...
    def image_to_image(self, actor_name, init_image, text_prompts, style_preset = "photographic", image_strength=0.35, cfg_scale=7, clip_guidance_preset="FAST_BLUE", samples=1, steps=30):
        if self.api_key:
            try:
                try:
